...
final class Template
{
    ...
    public function setThemePath(string $themePath): void
    {
        $paths = array_filter(
            ...
            fn(string $dir): bool => $this->fileSystem
                ->getFileInfo($dir)
                ->isDir(),
        );
    ...
    private function initializeTwig(): void
    {
        ...
        array_map($this->twigEnvironment->addFilter(...), [
            ...
            new TwigFilter(
                'autoDate',
                fn(?string $string) => $this->container
                    ->get(Date::class)
                    ->autoDate($string),
                ['is_safe' => ['html']],
            ),
            new TwigFilter(
                ...
                fn(?string $string) => $string
                    ? $this->container->get(Date::class)->smallDate($string)
                    : '',
                ['is_safe' => ['html']],
            ),
            new TwigFilter(
