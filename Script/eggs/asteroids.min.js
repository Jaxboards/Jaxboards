  ...
  function Asteroids() {
    ...
    if (typeof G_vmlCanvasManager != "undefined") {
      ...
      if (!this.canvas.getContext) {
        alert(
          "So... you're using IE?  Please join me at https://github.com/erkie/erkie.github.com if you think you can help",
        );
      }
    } else {
      if (!this.canvas.getContext) {
        alert(
          "This program does not yet support your browser. Please join me at https://github.com/erkie/erkie.github.com if you think you can help",
        );
      }
    }
    ...
    var eventKeyup = function (event) {
      ...
      switch (event.keyCode) {
        case code("B"):
          if (!window.ActiveXObject) removeStylesheet("ASTEROIDSYEAH");
          break;
      }
      if (
        indexOf(
  ...
  if (window.ActiveXObject) {
    try {
      ...
      xamlScript.textContent =
        '<?xml version="1.0"?><Canvas xmlns="https://schemas.microsoft.com/client/2007"></Canvas>';
