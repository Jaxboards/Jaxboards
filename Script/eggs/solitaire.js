/** Taken from https://github.com/rjanjic/js-solitaire/blob/master/src/index.js */
...
function solitaireGame(solitaireGameId) {
    const spriteImg =
    ...
    const game = document.getElementById(`solitaire-${solitaireGameId}`);
    const gameEl = game.querySelector('.solitaire');
    const dealPileEl = game.querySelector('.deck__pile');
    const dealEl = game.querySelector('.deck__deal');
    const finishContainerEl = game.querySelector('.finish-deck');
    const deskContainerEl = game.querySelector('.board-deck');
    const resetEl = game.querySelector('.new-game');
                ...
                <div class="window__content">
                    <div class="window__content-inner">
                        <div class="solitaire" >
                            ...
                            <div class="deck">
                                <div class="deck__pile"></div>
                                <div class="deck__deal"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
(function() {
    ...
    setTimeout(() => solitaireGame(solitaireGameId), 1000);
})();
