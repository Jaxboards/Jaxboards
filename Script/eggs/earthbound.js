  ...
  \******************************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            module.exports = function padStart(maxLength) {
              ...
              var filler =
                typeof fillString === "undefined" ? "" : ToString(fillString);
              if (filler === "") {
                filler = " ";
              }
                      ...
                      var drawFrame = function drawFrame() {
                        ...
                        if (elapsed > fpsInterval) {
                          ...
                          for (var i = 0; i < _this.layers.length; ++i) {
                            ...
                            bitmap = _this.layers[i].overlayFrame(
                              image.data,
                              _this.aspectRatio,
                              _this.tick,
                              _this.alpha[i],
  ...
  \**********************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var backgroundData = new Uint8Array(
              (0, _from2.default)(_truncated_backgrounds2.default).map(
                function (x) {
            ...
            var setupEngine = (exports.setupEngine = function setupEngine() {
              ...
              document.earthbound = new _engine2.default([layer1, layer2], {
                fps: fps,
                aspectRatio: aspectRatio,
                frameSkip: frameskip,
                alpha: [alpha, alpha],
                canvas: document.querySelector("#earthbound"),
              });
              ...
              (0, _createClass3.default)(BackgroundGraphics, [
                {
                  ...
                  value: function read(index) {
                    ...
                    var graphicsPointerBlock = (0, _rom.readBlock)(
                      0xd7a1 + index * 4,
                    );
                    /* Read graphics */
                    this.romGraphics.loadGraphics(
                      (0, _rom.readBlock)(
                        (0, _rom.snesToHex)(graphicsPointerBlock.readInt32()),
                      ),
                    );
                    /* Arrangement pointer table entry */
                    var arrayPointerBlock = (0, _rom.readBlock)(
                      0xd93d + index * 4,
                    );
              ...
              (0, _createClass3.default)(BackgroundLayer, [
                ...
                },
                {
                  ...
                  value: function loadEffect(index) {
                    this.distorter.effect = new _distortion_effect2.default(
                      index,
                    );
                  },
                },
  ...
  \******************************/
              ...
              (0, _createClass3.default)(Distorter, [
                {
                  ...
                  value: function setOffsetConstants(ticks, effect) {
                    ...
                    var t2 = ticks * 2;
                    this.amplitude =
                      this.C1 * (amplitude + amplitudeAcceleration * t2);
                    this.frequency =
                      this.C2 * (frequency + frequencyAcceleration * t2);
                    this.compression =
                    ...
                    this.S = function (y) {
                      return round(
                        _this.amplitude *
                          sin(_this.frequency * y + _this.speed),
                      );
                    };
                  },
                },
      ...
      */
                    ...
                    for (y = 0; y < _engine.SNES_HEIGHT; ++y) {
                      ...
                      var L =
                        distortionEffect === _distortion_effect.VERTICAL
                          ? offset
                          : y;
                      for (x = 0; x < _engine.SNES_WIDTH; ++x) {
                        ...
                        if (
                          y < letterbox ||
                          y > _engine.SNES_HEIGHT - letterbox
                        ) {
                          newBitmap[bPos + R] = 0;
                          newBitmap[bPos + G] = 0;
                          newBitmap[bPos + B] = 0;
                        ...
                        dx = x;
                        if (
                          distortionEffect === _distortion_effect.HORIZONTAL ||
                          distortionEffect ===
            ...
            var PaletteCycle = (function () {
              function PaletteCycle(_ref) {
                ...
                for (
                  ...
                  subPaletteNumber < this.originalColors.length;
                  ++subPaletteNumber
                ) {
                  this.nowColors[subPaletteNumber] = [];
                  for (var i = 16; i < 32; ++i) {
                    this.originalColors[subPaletteNumber][i] =
                      this.originalColors[subPaletteNumber][i - 16];
                    this.nowColors[subPaletteNumber][i - 16] =
                      this.originalColors[subPaletteNumber][i];
                  }
                }
              }
                    ...
                    if (this.type === 1 || this.type === 2) {
                      ...
                      for (
                        ...
                        for (var i = this.start1; i <= this.end1; ++i) {
                          ...
                          this.nowColors[subPaletteNumber][i] =
                            this.originalColors[subPaletteNumber][newColor];
                        }
                      }
                    }
                    if (this.type === 2) {
                      ...
                      for (
                        ...
                        _subPaletteNumber < this.originalColors.length;
                        ++_subPaletteNumber
                      ) {
                        for (var _i = this.start2; _i <= this.end2; ++_i) {
                          ...
                          this.nowColors[_subPaletteNumber][_i] =
                            this.originalColors[_subPaletteNumber][_newColor];
                        }
                      }
                    }
                    if (this.type === 3) {
                      ...
                      var _cycle1Position =
                        this.cycleCount % (_cycleLength2 * 2);
                      for (
                        var _subPaletteNumber2 = 0;
                        _subPaletteNumber2 < this.originalColors.length;
                        ++_subPaletteNumber2
                      ) {
                        for (var _i2 = this.start1; _i2 <= this.end1; ++_i2) {
                          ...
                          this.nowColors[_subPaletteNumber2][_i2] =
                            this.originalColors[_subPaletteNumber2][_newColor2];
                        }
                      }
                    }
                  },
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            function generateReversedBytes() {
              ...
              for (var i = 0; i < reversedBytes.length; ++i) {
                ...
                var reversed = []
                  .concat((0, _toConsumableArray3.default)(binary))
                  .reverse()
                  .join("");
            ...
            var ROM = (function () {
              function ROM(stream) {
                ...
                for (var _i = 0; _i < 114; ++_i) {
                  add(
                    this.objects,
                    new _background_palette2.default(_i, paletteBits[_i]),
                  );
                }
                /* Load graphics */
                for (var _i2 = 0; _i2 < 103; ++_i2) {
                  add(
                    this.objects,
                    new _background_graphics2.default(_i2, graphicsBits[_i2]),
                  );
                }
              }
              ...
              (0, _createClass3.default)(ROMGraphics, [
                {
                  ...
                  value: function buildTiles() {
                    var n =
                      this.gfxROMGraphics.length / (8 * this.bitsPerPixel);
                    this.tiles = [];
                    for (var i = 0; i < n; ++i) {
