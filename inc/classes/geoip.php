...
class GeoIP
{
    ...
    public function open()
    {
        ...
        $this->filehandle = fopen(dirname(__FILE__).'/GeoIP.dat', 'rb') or die('Can not open GeoIP db');
    }
    ...
    public function country_id($addr)
    {
        $addr = ip2long($addr);
    ...
    public function country_code($addr)
    {
        $id = $this->country_id($addr);

        return false !== $id ? $this->CC[$id] : $id;
    }

    public function country_name($addr)
    {
        $id = $this->country_id($addr);

        return false !== $id ? $this->CN[$id] : $id;
    }

    public function seek($ipnum)
    {
        $this->open();
        $offset = 0;
