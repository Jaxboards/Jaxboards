    ...
    public function execute(Database $database): void
    {
        ...
        $database->special(
            "CREATE TABLE %t
                ...
                KEY `user` (`user`),
                KEY `badge` (`badge`),
                CONSTRAINT `badge_associations_ibfk_1` FOREIGN KEY (`user`) REFERENCES `%t` (`id`) ON DELETE SET NULL,
                CONSTRAINT `badge_associations_ibfk_2` FOREIGN KEY (`badge`) REFERENCES `%t` (`id`) ON DELETE SET NULL",
