...
<table>
 <tr>
  <td class="left">
   <div class="username">%1$s</div>
   <div class="avatar"><img src="%2$s" /></div>
   <div class="usertitle">%3$s</div>
  </td>
  <td class="right">
   <a href="javascript:void(0)" onclick="IMWindow(\'%4$s\',this.innerHTML.match(/IM (.+)/)[1]);JAX.window.close(this);return false;">IM %1$s</a><br />
   <a href="?act=ucp&what=inbox&page=compose&mid=%4$s" onclick="JAX.window.close(this)">PM %1$s</a><br /><br />
   %6$s<br />
   %7$s<br /><br />
   <a href="?act=vu%4$s&view=profile" onclick="JAX.window.close(this)">Full Profile</a>
...
<div class="avatar"><img src="%2$s" /></div>
<div class="usertitle">%3$s</div>
<div class="infobox contact">Contact Details: <div class="content">%4$s</div></div>
<div class="infobox personal">Personal info: <div class="content">
  <div>Real name: %5$s</div>
  <div>Gender: %6$s</div>
  <div>Location: %7$s</div>
  <div>DOB: %8$s</div>
  <div>Site: %9$s</div>
</div></div>
<div class="infobox stats">Stats:
 <div class="content">
  <div>Joined: %10$s</div>
  <div>Last Visit: %11$s</div>
  <div>Member: #%12$s</div>
  <div>Posts: %13$s</div>
  <div>Group: %14$s</div>
</div></div>
</div>
<div class="rightbar pftabs" onclick="JAX.handleTabs(event,this)">%15$s%16$s%17$s%18$s%19$s%20$s</div>
