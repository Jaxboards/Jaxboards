...
'idx-row'=>'<tr id="fid_%1$s" class="%8$s"><td class="f_icon" rowspan="2">%9$s</td><td class="forum" rowspan="2"><a href="?act=vf%1$s">%2$s</a><div class="description">%3$s</div>%4$s%10$s</td><td class="last_post" id="fid_%1$s_lastpost" colspan="2">%5$s</td></tr><tr><td class="item_1" id="fid_%1$s_topics">%6$s</td><td class="item_2" id="fid_%1$s_replies">%7$s</td></tr>',
'idx-topics-count'=>'Topics: %s',
'idx-replies-count'=>'Replies: %s',
'idx-subforum-link'=>'<a href="?act=vf%1$s" title="%3$s" onmouseover="JAX.tooltip(this)">%2$s</a>',
'idx-subforum-splitter'=>', ',
'idx-subforum-wrapper'=>"<div class='subforums'>Subforums: %s</div>",
'idx-ledby-wrapper'=>"<div class='ledby'>Led By: %s</div>",
'idx-ledby-splitter'=>', ',
...
'idx-icon-unread'=>'<img src="http://jaxboards.com/Themes/Default/icons/unread.png" alt="unread" />',
'idx-icon-read'=>'<img src="http://jaxboards.com/Themes/Default/icons/read.png" alt="read" />',
'idx-icon-redirect'=>'<img src="http://jaxboards.com/Themes/Default/icons/redirect.png" alt="redirect" />',
