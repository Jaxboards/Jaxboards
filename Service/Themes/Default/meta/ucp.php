...
<div class="leftbar" class="folders">
 <h2>Settings</h2>
  ...
  <a href="?act=ucp&what=pass">Change Password</a>
  <a href="?act=ucp&what=email">Email</a>
  <a href="?act=ucp&what=avatar">Avatar</a>
  <a href="?act=ucp&what=signature">Signature</a>
  <a href="?act=ucp&what=profile">Profile</a>
  <a href="?act=ucp&what=sounds">Sounds/Notifications</a>
  <a href="?act=ucp&what=board">Board Customization</a>
  <h2>Private Messaging</h2>
 <a class="icon compose" href="?act=ucp&what=inbox&page=compose">Compose</a>
 <a class="icon inbox" href="?act=ucp&what=inbox">Inbox</a>
 <a class="icon sent" href="?act=ucp&what=inbox&page=sent">Sent</a>
 <a class="icon flagged" href="?act=ucp&what=inbox&page=flagged">Flagged</a>
 </div>
...
&nbsp;%s play a sound<br />
<br />
When someone IMs me:<br />
&nbsp;%s play a sound<br />
&nbsp;<input type="checkbox" onclick="if(!window.webkitNotifications) alert(\'browser not supported\');webkitNotifications.requestPermission()" id="dtnotify" /> display a desktop notification<br />
<br />
When someone PMs me:<br />
&nbsp;%s play a sound<br />
&nbsp;%s display a notification<br />
<br />
When someone posts in a topic I\'ve created:<br />
&nbsp;%s play a sound<br />
&nbsp;%s display a notification<br />
<br />
When someone posts in a topic I\'m subscribed to:<br />
&nbsp;%s play a sound<br />
&nbsp;%s display a notification<br />
<br />
<input type="submit" value="Save" />
...
<div><label for="realname">Real name:</label><input type="text" name="full_name" id="realname" value="%s"/></div>
<div><label for="usertitle">Title: </label><input type="text" name="usertitle" id="usertitle" value="%s" /></div>

<h2>About you:</h2>
<div class="description">
<textarea rows="10" cols="60" name="about" id="about">%s</textarea>
<iframe id="abouteditor" onload="JAX.editor($(\'about\'),this)" style="display:none"></iframe>
...
<h2>Contact Details (Optional)</h2>
  <div id="contact_details">
<div class="skype"><label for="con_skype">Skype:</label><input type="text" name="con_skype" id="con_skype" value="%s" /></div>
<div class="yim"><label for="con_yim">YIM:</label><input type="text" name="con_yim" id="con_yim" value="%s" /></div>
<div class="msn"><label for="con_msn">MSN:</label><input type="text" name="con_msn" id="con_msn" value="%s" /></div>
<div class="gtalk"><label for="con_gtalk">Google Talk:</label><input type="text" name="con_gtalk" id="con_gtalk" value="%s" /></div>
<div class="aim"><label for="con_aim">AIM:</label><input type="text" name="con_aim" id="con_aim" value="%s" /></div>
<div class="steam"><label for="con_steam">Steam:</label><input type="text" name="con_steam" id="con_steam" value="%s" /></div>
<div class="twitter"><label for="con_twitter">Twitter:</label><input type="text" name="con_twitter" id="con_twitter" value="%s" /></div>
</div>
...
<div class="messagebuttons">
 <form method="post" onsubmit="return RUN.submitForm(this,0,event)">%7$s
 ...
 <div><label for="to">To:</label>
      ...
      <input type="text" id="to" name="to" value="%3$s" onkeydown="if(event.keyCode==13) return false;" autocomplete="off" onkeyup="$(\'validname\').className=\'bad\';JAX.autoComplete(\'act=searchmembers&term=\'+this.value,this,$(\'mid\'),event);" />
      <span id="validname" class="%4$s"></span>
 </div>
 <div><label for="title">Title:</label>
      <input type="text" id="title" name="title" value="%5$s"/></div>
 <div><textarea id="message" name="message">%6$s</textarea><iframe onload="JAX.editor($(\'message\'),this)" style="display:none" id="pdedit"></iframe></div>
