    ...
    public function showskinindex(): void
    {
        ...
        if (isset($JAX->p['newwrapper']) && $JAX->p['newwrapper']) {
            ...
            if (preg_match('@[^\w ]@', $JAX->p['newwrapper'])) {
                ...
                if ($o !== false) {
                    fwrite($o, file_get_contents(DTHEMEPATH.'wrappers.txt'));
                    fclose($o);
                } else {
        ...
        while ($f = $DB->arow($result)) {
            ...
            $skins .= $PAGE->parseTemplate(
                ...
                [
                    ...
                    'title' => $f['title'],
                    'custom' => $f['custom'] ?
                        $PAGE->parseTemplate('themes/show-skin-index-css-row-custom.html') : '',
        ...
        $PAGE->addContentBox(
            ...
            $PAGE->parseTemplate(
                ...
                [
                    ...
                    'save' => $skin['custom'] ? $PAGE->parseTemplate('save-changes.html') : '',
                ]
            )
        );
    }
        ...
        if (isset($JAX->p['submit']) && $JAX->p['submit']) {
            ...
            if (! isset($JAX->p['skinname']) || ! $JAX->p['skinname']) {
                ...
                if (is_dir(BOARDPATH.'Themes')) {
                    ...
                    fwrite($o, file_get_contents(DTHEMEPATH.'css.css'));
                    fclose($o);
                }
                $PAGE->location('?act=themes');
            }
